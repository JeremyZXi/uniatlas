var size = 0;
var placement = 'point';
function categories_Universities_Nov15_45(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                var valueStr = (value !== null && value !== undefined) ? value.toString() : 'default';
                switch(valueStr) {case 'Liberal Arts':
                    return [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 4.2 + size, points: 3,
...
var style_Universities_Nov15_45 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_Universities_Nov15_45(feature, value, size, resolution, labelText,
