var size = 0;
var placement = 'point';
function categories_TestPolicy_18(feature, value, size, resolution, labelText,
...
var style_TestPolicy_18 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (size == 1) { // If cluster has one feature
        ...
        value = clusteredFeatures[0].get("Test-Optional");
    ...
    var style = categories_TestPolicy_18(feature, value, size, resolution, labelText,
