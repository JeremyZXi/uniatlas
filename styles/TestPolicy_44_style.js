var size = 0;
var placement = 'point';
function categories_TestPolicy_44(feature, value, size, resolution, labelText,
...
var style_TestPolicy_44 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_TestPolicy_44(feature, value, size, resolution, labelText,
