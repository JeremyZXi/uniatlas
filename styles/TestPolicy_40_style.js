var size = 0;
var placement = 'point';
function categories_TestPolicy_40(feature, value, size, resolution, labelText,
...
var style_TestPolicy_40 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_TestPolicy_40(feature, value, size, resolution, labelText,
