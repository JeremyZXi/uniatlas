...
var style_UndergraduateSize_43 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    if (value >= 921.000000 && value <= 6657.750000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 5.714285714285714 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 7.428571428571429 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 9.142857142857142 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 10.857142857142858 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 12.571428571428571 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
            ...
            style = [ new ol.style.Style({
        image: new ol.style.Circle({radius: 14.285714285714286 + size,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(25,25,25,0.29411764705882354)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 3.04}), fill: new ol.style.Fill({color: 'rgba(229,229,229,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
