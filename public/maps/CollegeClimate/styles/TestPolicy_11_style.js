var size = 0;
var placement = 'point';
function categories_TestPolicy_11(feature, value, size, resolution, labelText,
...
var style_TestPolicy_11 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = categories_TestPolicy_11(feature, value, size, resolution, labelText,
